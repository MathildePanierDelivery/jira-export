"""
export_v4_palier.py — PALIER 1 : Suivi de production
=====================================================
Première version du nouveau script, branchée sur le cache Tempo.
Ne génère QUE l'onglet "Suivi de production" pour validation.

Prérequis : lancer d'abord collect_jira_worklogs.py (génère jira_cache.pkl)
Sortie     : jira_export_TEST.xlsx  (nom distinct pour comparer sans écraser)
"""
